...
public class PadTcpClient
{
    ...
    {
        nogamepads_data.TcpClientBindAddressV4(_serviceFfi, (byte) a0, (byte) a1, (byte) a2, (byte) a3, ushort.Parse(port + ""));
        return this;
    }
    
    public PadTcpClient SetAddressV6(string address = "::1", int port = 5989)
    {
        nogamepads_data.TcpClientBindAddressV6(_serviceFfi, address, ushort.Parse(port + ""));
        return this;
    }
